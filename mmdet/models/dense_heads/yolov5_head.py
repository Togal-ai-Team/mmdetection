...
from ..utils import make_divisible_mmyolo
...
class YOLOv5HeadModule(BaseModule):
    ...
    def __init__(self,
        ...
        if isinstance(in_channels, int):
            self.in_channels = [make_divisible_mmyolo(in_channels, widen_factor)
                                ] * self.num_levels
        else:
            self.in_channels = [
                make_divisible_mmyolo(i, widen_factor) for i in in_channels
            ]
