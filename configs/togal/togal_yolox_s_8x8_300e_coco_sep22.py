...
wandb_experiment_name = 'detection: 25 classes baseline, resume from baseline, new dataset(with toilet, sink, shower, bathtub)'
...
model = dict(
    ...
    neck=dict(
        ...
        init_cfg=init_cfg),
    bbox_head=dict(
        type='YOLOXHead', num_classes=25, in_channels=128, feat_channels=128, init_cfg=init_cfg),
...
resume_from = None
load_from = 'work_dirs/togal_yolox_s_8x8_300e_coco_sep22/latest.pth'
interval = 10000
