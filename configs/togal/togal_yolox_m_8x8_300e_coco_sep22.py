...
train_pipeline = [
    ...
    dict(type='RandomFlip', direction = ["horizontal", "vertical", "diagonal"], flip_ratio=0.2),
...
resume_from = None
load_from = 'work_dirs/togal_yolox_m_8x8_300e_coco_sep22/best_bbox_mAP_iter_85000.pth'
interval = 10000
