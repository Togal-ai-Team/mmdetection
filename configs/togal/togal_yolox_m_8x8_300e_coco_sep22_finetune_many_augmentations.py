...
wandb_experiment_name = 'detection: 25 classes baseline, yolox-m, pretrained checkpoint, lower learning rate, mostly rotation augmentations, finetune on V100'
...
model = dict(
    ...
    random_size_interval=1000000000,
...
train_pipeline = [
    ...
    dict(type='Albu',
        bbox_params = dict(type='BboxParams', format='pascal_voc', label_fields=['gt_labels']),
         transforms = [
            dict(type='RandomBrightness', limit=(0.1, 0.3), p=0.1),
...
resume_from = None
load_from = 'work_dirs/togal_yolox_m_8x8_300e_coco_sep22_finetune_many_augmentations/best_bbox_mAP_iter_80000.pth'
interval = 10000
